...
namespace PLEXOS.Identity.Controllers
{
    ...
    public class OrganizationsAPIController : Controller
    {
        ...
        public async Task<List<Organization>> Index()
        {
          //  var me = User;
      //    var isAdmin = me.IsInRole("Admin");
            return await _context.Organizations.ToListAsync();
        }

        public async Task<List<Organization>> All()
        {
           return await _context.Organizations.ToListAsync();
        }

        // GET: Organizations/Details/5
        public async Task<Organization> Details(string id)
        {
            if (id == null)
            {
